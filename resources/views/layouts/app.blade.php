...
<div id="app">
        ...
        <div class="sidebar-r">
            ...
            <div class="user-h">
                <el-menu class="el-menu-demo" mode="horizontal"  background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
                    <el-submenu index="2">
                        <template slot="title"><img src="/static/img/user.png" alt="" class="tit-user clearfix">{{ Auth::user()->username }}</template>
                            ...
                            <el-menu-item index="2-2" @click="logout"><i class="fa fa-sign-out" style="color: #fff;display: inline-block;margin: 0 20px 0px 10px;"></i>
    ...
    <div class="nav">
        ...
        <div class="homepage-tab">
            <el-tabs class="input-new-tag" size="medium" closable @tab-remove="removeTab">
