...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__api_permission__["b" /* getPermissions */])().then(function (res) {
    ...
    methods: {
        ...
        submitForm: function submitForm() {
            ...
            if (this.formType === 'edit') {
                Object(__WEBPACK_IMPORTED_MODULE_0__api_permission__["c" /* updatePermissions */])(this.id, this.form).then(function (res) {
                    if (res.data.response_status === "success") {
        ...
        handleEdit: function handleEdit(data) {
            ...
            this.formType = 'edit';
            Object(__WEBPACK_IMPORTED_MODULE_0__api_permission__["a" /* editPermissions */])(data.id).then(function (res) {
                if (res.data.response_status === "success") {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = getPermissions;
/* harmony export (immutable) */ __webpack_exports__["a"] = editPermissions;
/* harmony export (immutable) */ __webpack_exports__["c"] = updatePermissions;
              ...
              _c(
                ...
                [
                  _c(
                    "el-select",
                    {
                      attrs: { placeholder: "请选择", "value-key": "item" },
                      model: {
                    ...
                    _vm._l(_vm.options, function(item) {
                      return _c("el-option", {
                        ...
                        attrs: {
                          value: item.id,
                          label: item.parent_id === 0 ? "顶级菜单" : item.label
                        }
                      })
                    })
                  )
