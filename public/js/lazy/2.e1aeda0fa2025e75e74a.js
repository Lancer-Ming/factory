    ...
    methods: {
        submitForm: function submitForm() {
            ...
            if (this.formType === 'edit') {
                Object(__WEBPACK_IMPORTED_MODULE_0__api_permission__["f" /* updatePermissions */])(this.id, this.form).then(function (res) {
        ...
        handleDragEnd: function handleDragEnd() {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_0__api_permission__["e" /* sortPermissions */])(data).then(function (res) {
                if (res.data.response_status === "success") {
                    _this5.successCallback(res);
                }
            });
        },
...
/* harmony export (immutable) */ __webpack_exports__["f"] = updatePermissions;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = sortPermissions;
