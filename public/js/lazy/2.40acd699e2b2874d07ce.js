...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__api_permission__["c" /* getPermissions */])().then(function (res) {
    ...
    methods: {
        ...
        submitForm: function submitForm() {
            ...
            if (this.formType === 'edit') {
                Object(__WEBPACK_IMPORTED_MODULE_0__api_permission__["d" /* updatePermissions */])(this.id, this.form).then(function (res) {
        ...
        handleEdit: function handleEdit(data) {
            ...
            this.formType = 'edit';
            Object(__WEBPACK_IMPORTED_MODULE_0__api_permission__["b" /* editPermissions */])(data.id).then(function (res) {
                if (res.data.response_status === "success") {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["c"] = getPermissions;
/* harmony export (immutable) */ __webpack_exports__["b"] = editPermissions;
/* harmony export (immutable) */ __webpack_exports__["d"] = updatePermissions;
/* harmony export (immutable) */ __webpack_exports__["a"] = addPermissions;
/* unused harmony export deletePermissions */
